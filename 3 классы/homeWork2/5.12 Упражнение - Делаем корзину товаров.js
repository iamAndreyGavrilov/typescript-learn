...
//     // Вызываем super для того чтобы передать в Delivery - date
//     super(date);
//   }
// }
...
// }
// const cart = new Cart();
// cart.addProduct(new Product(1, "Biscuit", 10));
// cart.addProduct(new Product(2, "Pie", 30));
// cart.addProduct(new Product(3, "Chocolate", 20));
// cart.deleteProduct(1);
// cart.setDelivery(new HomeDelivery(new Date(), "адрес доставки"));
